...
export interface TextureBrushSettings {
  ...
  fadeIn: number      // START taper distance as a fraction of size (fade in at the start of the path)
  fadeOut: number     // END taper distance as a fraction of size (fade out at the end of the path)
