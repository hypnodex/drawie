...
/**
 * Shared screen header — a centered title with an optional back link, over the shadcn tokens.
 * Equal-width side slots keep the title centered. Reused across the native screens.
 */
